...
inline const Interpolation (&EnumValuesInterpolation())[1] {
    static const Interpolation values[] = { Interpolation_LINEAR };
    return values;
}

inline const char *const *EnumNamesInterpolation() {
    static const char *const names[] = { "LINEAR", nullptr };
    return names;
}
...
inline const AccessorType (&EnumValuesAccessorType())[4] {
    static const AccessorType values[] = { AccessorType_SCALAR, AccessorType_VEC2,
                                           AccessorType_VEC3, AccessorType_VEC4 };
    return values;
}

inline const char *const *EnumNamesAccessorType() {
    static const char *const names[] = { "SCALAR", "VEC2", "VEC3", "VEC4", nullptr };
    return names;
}
...
struct Asset FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
    enum { VT_GENERATOR = 4, VT_VERSION = 6 };
    ...
    bool Verify(flatbuffers::Verifier &verifier) const {
        return VerifyTableStart(verifier) && VerifyOffset(verifier, VT_GENERATOR) &&
               verifier.VerifyString(generator()) && VerifyOffset(verifier, VT_VERSION) &&
...
inline flatbuffers::Offset<Asset> CreateAsset(
    flatbuffers::FlatBufferBuilder &_fbb, flatbuffers::Offset<flatbuffers::String> generator = 0,
...
struct Scene FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
    ...
    bool Verify(flatbuffers::Verifier &verifier) const {
        return VerifyTableStart(verifier) && VerifyOffset(verifier, VT_NAME) &&
               verifier.VerifyString(name()) && VerifyOffset(verifier, VT_NODES) &&
...
inline flatbuffers::Offset<Scene> CreateSceneDirect(flatbuffers::FlatBufferBuilder &_fbb,
    ...
    return gltf::CreateScene(_fbb, name ? _fbb.CreateString(name) : 0,
...
struct Node FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
    ...
    int32_t mesh() const { return GetField<int32_t>(VT_MESH, 0); }
    const flatbuffers::String *name() const {
        return GetPointer<const flatbuffers::String *>(VT_NAME);
    }
    ...
    bool Verify(flatbuffers::Verifier &verifier) const {
        return VerifyTableStart(verifier) && VerifyField<int32_t>(verifier, VT_MESH) &&
               VerifyOffset(verifier, VT_NAME) && verifier.VerifyString(name()) &&
               VerifyOffset(verifier, VT_CHILDREN) && verifier.VerifyVector(children()) &&
               VerifyOffset(verifier, VT_TRANSLATION) && verifier.VerifyVector(translation()) &&
               VerifyOffset(verifier, VT_ROTATION) && verifier.VerifyVector(rotation()) &&
               VerifyOffset(verifier, VT_SCALE) && verifier.VerifyVector(scale()) &&
               verifier.EndTable();
    }
};
...
struct NodeBuilder {
    flatbuffers::FlatBufferBuilder &fbb_;
    flatbuffers::uoffset_t start_;
    void add_mesh(int32_t mesh) { fbb_.AddElement<int32_t>(Node::VT_MESH, mesh, 0); }
    void add_name(flatbuffers::Offset<flatbuffers::String> name) {
    ...
    explicit NodeBuilder(flatbuffers::FlatBufferBuilder &_fbb) : fbb_(_fbb) {
        start_ = fbb_.StartTable();
    }
...
inline flatbuffers::Offset<Node> CreateNode(
    flatbuffers::FlatBufferBuilder &_fbb, int32_t mesh = 0,
...
inline flatbuffers::Offset<Node> CreateNodeDirect(flatbuffers::FlatBufferBuilder &_fbb,
                                                  int32_t mesh = 0, const char *name = nullptr,
    ...
    return gltf::CreateNode(_fbb, mesh, name ? _fbb.CreateString(name) : 0,
...
struct Target FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
    enum { VT_NODE = 4, VT_PATH = 6 };
    int32_t node() const { return GetField<int32_t>(VT_NODE, 0); }
    const flatbuffers::String *path() const {
        return GetPointer<const flatbuffers::String *>(VT_PATH);
    }
    bool Verify(flatbuffers::Verifier &verifier) const {
        return VerifyTableStart(verifier) && VerifyField<int32_t>(verifier, VT_NODE) &&
               VerifyOffset(verifier, VT_PATH) && verifier.VerifyString(path()) &&
               verifier.EndTable();
    }
};
...
struct TargetBuilder {
    flatbuffers::FlatBufferBuilder &fbb_;
    flatbuffers::uoffset_t start_;
    void add_node(int32_t node) { fbb_.AddElement<int32_t>(Target::VT_NODE, node, 0); }
    void add_path(flatbuffers::Offset<flatbuffers::String> path) {
        fbb_.AddOffset(Target::VT_PATH, path);
    }
    explicit TargetBuilder(flatbuffers::FlatBufferBuilder &_fbb) : fbb_(_fbb) {
        start_ = fbb_.StartTable();
    }
...
inline flatbuffers::Offset<Target> CreateTarget(flatbuffers::FlatBufferBuilder &_fbb,
                                                int32_t node = 0,
...
inline flatbuffers::Offset<Target> CreateTargetDirect(flatbuffers::FlatBufferBuilder &_fbb,
                                                      int32_t node = 0,
                                                      const char *path = nullptr) {
    return gltf::CreateTarget(_fbb, node, path ? _fbb.CreateString(path) : 0);
}

struct Channel FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
    enum { VT_SAMPLER = 4, VT_TARGET = 6 };
    int32_t sampler() const { return GetField<int32_t>(VT_SAMPLER, 0); }
    const Target *target() const { return GetPointer<const Target *>(VT_TARGET); }
    bool Verify(flatbuffers::Verifier &verifier) const {
        return VerifyTableStart(verifier) && VerifyField<int32_t>(verifier, VT_SAMPLER) &&
               VerifyOffset(verifier, VT_TARGET) && verifier.VerifyTable(target()) &&
               verifier.EndTable();
    }
};
...
struct ChannelBuilder {
    flatbuffers::FlatBufferBuilder &fbb_;
    flatbuffers::uoffset_t start_;
    void add_sampler(int32_t sampler) { fbb_.AddElement<int32_t>(Channel::VT_SAMPLER, sampler, 0); }
    void add_target(flatbuffers::Offset<Target> target) {
        fbb_.AddOffset(Channel::VT_TARGET, target);
    }
    explicit ChannelBuilder(flatbuffers::FlatBufferBuilder &_fbb) : fbb_(_fbb) {
        start_ = fbb_.StartTable();
    }
...
struct Sampler FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
    enum { VT_INPUT = 4, VT_INTERPOLATION = 6, VT_OUTPUT = 8 };
    int32_t input() const { return GetField<int32_t>(VT_INPUT, 0); }
    Interpolation interpolation() const {
        return static_cast<Interpolation>(GetField<int16_t>(VT_INTERPOLATION, 0));
    }
    int32_t output() const { return GetField<int32_t>(VT_OUTPUT, 0); }
    bool Verify(flatbuffers::Verifier &verifier) const {
        return VerifyTableStart(verifier) && VerifyField<int32_t>(verifier, VT_INPUT) &&
               VerifyField<int16_t>(verifier, VT_INTERPOLATION) &&
               VerifyField<int32_t>(verifier, VT_OUTPUT) && verifier.EndTable();
    }
};
...
struct SamplerBuilder {
    flatbuffers::FlatBufferBuilder &fbb_;
    flatbuffers::uoffset_t start_;
    void add_input(int32_t input) { fbb_.AddElement<int32_t>(Sampler::VT_INPUT, input, 0); }
    ...
    void add_output(int32_t output) { fbb_.AddElement<int32_t>(Sampler::VT_OUTPUT, output, 0); }
    explicit SamplerBuilder(flatbuffers::FlatBufferBuilder &_fbb) : fbb_(_fbb) {
        start_ = fbb_.StartTable();
    }
...
inline flatbuffers::Offset<Sampler> CreateSampler(
    flatbuffers::FlatBufferBuilder &_fbb, int32_t input = 0,
    Interpolation interpolation = Interpolation_LINEAR, int32_t output = 0) {
...
struct Animation FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
    enum { VT_CHANNELS = 4, VT_NAME = 6, VT_SAMPLERS = 8 };
    ...
    bool Verify(flatbuffers::Verifier &verifier) const {
        return VerifyTableStart(verifier) && VerifyOffset(verifier, VT_CHANNELS) &&
               verifier.VerifyVector(channels()) && verifier.VerifyVectorOfTables(channels()) &&
               VerifyOffset(verifier, VT_NAME) && verifier.VerifyString(name()) &&
               VerifyOffset(verifier, VT_SAMPLERS) && verifier.VerifyVector(samplers()) &&
               verifier.VerifyVectorOfTables(samplers()) && verifier.EndTable();
    }
};
...
struct AnimationBuilder {
    ...
    flatbuffers::uoffset_t start_;
    void add_channels(
        flatbuffers::Offset<flatbuffers::Vector<flatbuffers::Offset<Channel>>> channels) {
    ...
    void add_samplers(
        flatbuffers::Offset<flatbuffers::Vector<flatbuffers::Offset<Sampler>>> samplers) {
        fbb_.AddOffset(Animation::VT_SAMPLERS, samplers);
    }
    explicit AnimationBuilder(flatbuffers::FlatBufferBuilder &_fbb) : fbb_(_fbb) {
        start_ = fbb_.StartTable();
    }
...
inline flatbuffers::Offset<Animation> CreateAnimationDirect(
    flatbuffers::FlatBufferBuilder &_fbb,
    const std::vector<flatbuffers::Offset<Channel>> *channels = nullptr, const char *name = nullptr,
    const std::vector<flatbuffers::Offset<Sampler>> *samplers = nullptr) {
    return gltf::CreateAnimation(
        _fbb, channels ? _fbb.CreateVector<flatbuffers::Offset<Channel>>(*channels) : 0,
...
struct ColorTexture FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
    enum { VT_INDEX = 4, VT_TEXCOORD = 6 };
    int32_t index() const { return GetField<int32_t>(VT_INDEX, 0); }
    int32_t texCoord() const { return GetField<int32_t>(VT_TEXCOORD, 0); }
    bool Verify(flatbuffers::Verifier &verifier) const {
        return VerifyTableStart(verifier) && VerifyField<int32_t>(verifier, VT_INDEX) &&
               VerifyField<int32_t>(verifier, VT_TEXCOORD) && verifier.EndTable();
    }
};
...
struct ColorTextureBuilder {
    flatbuffers::FlatBufferBuilder &fbb_;
    flatbuffers::uoffset_t start_;
    void add_index(int32_t index) { fbb_.AddElement<int32_t>(ColorTexture::VT_INDEX, index, 0); }
    void add_texCoord(int32_t texCoord) {
        fbb_.AddElement<int32_t>(ColorTexture::VT_TEXCOORD, texCoord, 0);
    }
    explicit ColorTextureBuilder(flatbuffers::FlatBufferBuilder &_fbb) : fbb_(_fbb) {
        start_ = fbb_.StartTable();
    }
...
inline flatbuffers::Offset<ColorTexture> CreateColorTexture(flatbuffers::FlatBufferBuilder &_fbb,
                                                            int32_t index = 0,
                                                            int32_t texCoord = 0) {
...
struct MetallicRoughness FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
    enum { VT_BASECOLORTEXTURE = 4, VT_METALLICFACTOR = 6, VT_ROUGHNESSFACTOR = 8 };
    const ColorTexture *baseColorTexture() const {
        return GetPointer<const ColorTexture *>(VT_BASECOLORTEXTURE);
    }
    float metallicFactor() const { return GetField<float>(VT_METALLICFACTOR, 0.0f); }
    float roughnessFactor() const { return GetField<float>(VT_ROUGHNESSFACTOR, 0.0f); }
    bool Verify(flatbuffers::Verifier &verifier) const {
        return VerifyTableStart(verifier) && VerifyOffset(verifier, VT_BASECOLORTEXTURE) &&
               verifier.VerifyTable(baseColorTexture()) &&
               VerifyField<float>(verifier, VT_METALLICFACTOR) &&
               VerifyField<float>(verifier, VT_ROUGHNESSFACTOR) && verifier.EndTable();
    }
};
...
struct MetallicRoughnessBuilder {
    ...
    explicit MetallicRoughnessBuilder(flatbuffers::FlatBufferBuilder &_fbb) : fbb_(_fbb) {
        start_ = fbb_.StartTable();
    }
...
inline flatbuffers::Offset<MetallicRoughness> CreateMetallicRoughness(
    flatbuffers::FlatBufferBuilder &_fbb, flatbuffers::Offset<ColorTexture> baseColorTexture = 0,
    float metallicFactor = 0.0f, float roughnessFactor = 0.0f) {
...
struct Material FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
    enum { VT_NAME = 4, VT_PBRMETALLICROUGHNESS = 6 };
    const flatbuffers::String *name() const {
        return GetPointer<const flatbuffers::String *>(VT_NAME);
    }
    ...
    bool Verify(flatbuffers::Verifier &verifier) const {
        return VerifyTableStart(verifier) && VerifyOffset(verifier, VT_NAME) &&
               verifier.VerifyString(name()) && VerifyOffset(verifier, VT_PBRMETALLICROUGHNESS) &&
               verifier.VerifyTable(pbrMetallicRoughness()) && verifier.EndTable();
    }
};
...
struct MaterialBuilder {
    ...
    explicit MaterialBuilder(flatbuffers::FlatBufferBuilder &_fbb) : fbb_(_fbb) {
        start_ = fbb_.StartTable();
    }
...
inline flatbuffers::Offset<Material> CreateMaterialDirect(
    ...
    flatbuffers::Offset<MetallicRoughness> pbrMetallicRoughness = 0) {
    return gltf::CreateMaterial(_fbb, name ? _fbb.CreateString(name) : 0, pbrMetallicRoughness);
}

struct Attributes FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
    enum { VT_POSITION = 4, VT_NORMAL = 6, VT_TANGENT = 8, VT_TEXCOORD_0 = 10 };
    int32_t POSITION() const { return GetField<int32_t>(VT_POSITION, 0); }
    int32_t NORMAL() const { return GetField<int32_t>(VT_NORMAL, 0); }
    int32_t TANGENT() const { return GetField<int32_t>(VT_TANGENT, 0); }
    int32_t TEXCOORD_0() const { return GetField<int32_t>(VT_TEXCOORD_0, 0); }
    bool Verify(flatbuffers::Verifier &verifier) const {
        return VerifyTableStart(verifier) && VerifyField<int32_t>(verifier, VT_POSITION) &&
               VerifyField<int32_t>(verifier, VT_NORMAL) &&
               VerifyField<int32_t>(verifier, VT_TANGENT) &&
               VerifyField<int32_t>(verifier, VT_TEXCOORD_0) && verifier.EndTable();
    }
};
...
struct AttributesBuilder {
    ...
    void add_NORMAL(int32_t NORMAL) { fbb_.AddElement<int32_t>(Attributes::VT_NORMAL, NORMAL, 0); }
    ...
    explicit AttributesBuilder(flatbuffers::FlatBufferBuilder &_fbb) : fbb_(_fbb) {
        start_ = fbb_.StartTable();
    }
...
inline flatbuffers::Offset<Attributes> CreateAttributes(flatbuffers::FlatBufferBuilder &_fbb,
                                                        int32_t POSITION = 0, int32_t NORMAL = 0,
                                                        int32_t TANGENT = 0,
...
struct Primitive FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
    enum { VT_ATTRIBUTES = 4, VT_INDICES = 6, VT_MATERIAL = 8, VT_MODE = 10 };
    const Attributes *attributes() const { return GetPointer<const Attributes *>(VT_ATTRIBUTES); }
    int32_t indices() const { return GetField<int32_t>(VT_INDICES, 0); }
    int32_t material() const { return GetField<int32_t>(VT_MATERIAL, 0); }
    int32_t mode() const { return GetField<int32_t>(VT_MODE, 0); }
    bool Verify(flatbuffers::Verifier &verifier) const {
        return VerifyTableStart(verifier) && VerifyOffset(verifier, VT_ATTRIBUTES) &&
               verifier.VerifyTable(attributes()) && VerifyField<int32_t>(verifier, VT_INDICES) &&
               VerifyField<int32_t>(verifier, VT_MATERIAL) &&
               VerifyField<int32_t>(verifier, VT_MODE) && verifier.EndTable();
    }
};
...
struct PrimitiveBuilder {
    ...
    void add_mode(int32_t mode) { fbb_.AddElement<int32_t>(Primitive::VT_MODE, mode, 0); }
    explicit PrimitiveBuilder(flatbuffers::FlatBufferBuilder &_fbb) : fbb_(_fbb) {
        start_ = fbb_.StartTable();
    }
...
inline flatbuffers::Offset<Primitive> CreatePrimitive(
    flatbuffers::FlatBufferBuilder &_fbb, flatbuffers::Offset<Attributes> attributes = 0,
    int32_t indices = 0, int32_t material = 0, int32_t mode = 0) {
...
struct Mesh FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
    enum { VT_NAME = 4, VT_PRIMITIVES = 6 };
    const flatbuffers::String *name() const {
        return GetPointer<const flatbuffers::String *>(VT_NAME);
    }
    const flatbuffers::Vector<flatbuffers::Offset<Primitive>> *primitives() const {
        return GetPointer<const flatbuffers::Vector<flatbuffers::Offset<Primitive>> *>(
            VT_PRIMITIVES);
    }
    bool Verify(flatbuffers::Verifier &verifier) const {
        return VerifyTableStart(verifier) && VerifyOffset(verifier, VT_NAME) &&
               verifier.VerifyString(name()) && VerifyOffset(verifier, VT_PRIMITIVES) &&
               verifier.VerifyVector(primitives()) && verifier.VerifyVectorOfTables(primitives()) &&
               verifier.EndTable();
    }
};
...
struct MeshBuilder {
    ...
    void add_primitives(
        flatbuffers::Offset<flatbuffers::Vector<flatbuffers::Offset<Primitive>>> primitives) {
        fbb_.AddOffset(Mesh::VT_PRIMITIVES, primitives);
    }
    explicit MeshBuilder(flatbuffers::FlatBufferBuilder &_fbb) : fbb_(_fbb) {
        start_ = fbb_.StartTable();
    }
...
struct Texture FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
    enum { VT_SOURCE = 4 };
    int32_t source() const { return GetField<int32_t>(VT_SOURCE, 0); }
    bool Verify(flatbuffers::Verifier &verifier) const {
        return VerifyTableStart(verifier) && VerifyField<int32_t>(verifier, VT_SOURCE) &&
               verifier.EndTable();
    }
};
...
struct TextureBuilder {
    flatbuffers::FlatBufferBuilder &fbb_;
    flatbuffers::uoffset_t start_;
    void add_source(int32_t source) { fbb_.AddElement<int32_t>(Texture::VT_SOURCE, source, 0); }
    explicit TextureBuilder(flatbuffers::FlatBufferBuilder &_fbb) : fbb_(_fbb) {
        start_ = fbb_.StartTable();
    }
...
struct Image FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
    enum { VT_MIMETYPE = 4, VT_NAME = 6, VT_URI = 8 };
    ...
    bool Verify(flatbuffers::Verifier &verifier) const {
        return VerifyTableStart(verifier) && VerifyOffset(verifier, VT_MIMETYPE) &&
               verifier.VerifyString(mimeType()) && VerifyOffset(verifier, VT_NAME) &&
               verifier.VerifyString(name()) && VerifyOffset(verifier, VT_URI) &&
               verifier.VerifyString(uri()) && verifier.EndTable();
    }
};
...
struct ImageBuilder {
    ...
    explicit ImageBuilder(flatbuffers::FlatBufferBuilder &_fbb) : fbb_(_fbb) {
        start_ = fbb_.StartTable();
    }
...
inline flatbuffers::Offset<Image> CreateImageDirect(flatbuffers::FlatBufferBuilder &_fbb,
    ...
    return gltf::CreateImage(_fbb, mimeType ? _fbb.CreateString(mimeType) : 0,
                             name ? _fbb.CreateString(name) : 0, uri ? _fbb.CreateString(uri) : 0);
}
...
struct Accessor FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
    ...
    int32_t bufferView() const { return GetField<int32_t>(VT_BUFFERVIEW, 0); }
    int32_t byteOffset() const { return GetField<int32_t>(VT_BYTEOFFSET, 0); }
    int32_t componentType() const { return GetField<int32_t>(VT_COMPONENTTYPE, 0); }
    ...
    bool Verify(flatbuffers::Verifier &verifier) const {
        return VerifyTableStart(verifier) && VerifyField<int32_t>(verifier, VT_BUFFERVIEW) &&
               ...
               VerifyOffset(verifier, VT_TYPE) && verifier.VerifyString(type()) &&
               VerifyField<int32_t>(verifier, VT_COUNT) && VerifyOffset(verifier, VT_MAX) &&
               verifier.VerifyVector(max()) && VerifyOffset(verifier, VT_MIN) &&
               verifier.VerifyVector(min()) && verifier.EndTable();
    }
};
...
struct AccessorBuilder {
    ...
    void add_count(int32_t count) { fbb_.AddElement<int32_t>(Accessor::VT_COUNT, count, 0); }
    ...
    explicit AccessorBuilder(flatbuffers::FlatBufferBuilder &_fbb) : fbb_(_fbb) {
        start_ = fbb_.StartTable();
    }
...
inline flatbuffers::Offset<Accessor> CreateAccessor(
    flatbuffers::FlatBufferBuilder &_fbb, int32_t bufferView = 0, int32_t byteOffset = 0,
    int32_t componentType = 0, flatbuffers::Offset<flatbuffers::String> type = 0, int32_t count = 0,
...
inline flatbuffers::Offset<Accessor> CreateAccessorDirect(
    flatbuffers::FlatBufferBuilder &_fbb, int32_t bufferView = 0, int32_t byteOffset = 0,
    int32_t componentType = 0, const char *type = nullptr, int32_t count = 0,
    const std::vector<float> *max = nullptr, const std::vector<float> *min = nullptr) {
    return gltf::CreateAccessor(
        _fbb, bufferView, byteOffset, componentType, type ? _fbb.CreateString(type) : 0, count,
        max ? _fbb.CreateVector<float>(*max) : 0, min ? _fbb.CreateVector<float>(*min) : 0);
}

struct BufferView FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
    enum { VT_BUFFER = 4, VT_BYTELENGTH = 6, VT_BYTEOFFSET = 8, VT_BYTESTRIDE = 10 };
    int32_t buffer() const { return GetField<int32_t>(VT_BUFFER, 0); }
    int32_t byteLength() const { return GetField<int32_t>(VT_BYTELENGTH, 0); }
    int32_t byteOffset() const { return GetField<int32_t>(VT_BYTEOFFSET, 0); }
    int32_t byteStride() const { return GetField<int32_t>(VT_BYTESTRIDE, 0); }
    bool Verify(flatbuffers::Verifier &verifier) const {
        return VerifyTableStart(verifier) && VerifyField<int32_t>(verifier, VT_BUFFER) &&
               VerifyField<int32_t>(verifier, VT_BYTELENGTH) &&
               VerifyField<int32_t>(verifier, VT_BYTEOFFSET) &&
               VerifyField<int32_t>(verifier, VT_BYTESTRIDE) && verifier.EndTable();
    }
};
...
struct BufferViewBuilder {
    flatbuffers::FlatBufferBuilder &fbb_;
    flatbuffers::uoffset_t start_;
    void add_buffer(int32_t buffer) { fbb_.AddElement<int32_t>(BufferView::VT_BUFFER, buffer, 0); }
    ...
    explicit BufferViewBuilder(flatbuffers::FlatBufferBuilder &_fbb) : fbb_(_fbb) {
        start_ = fbb_.StartTable();
    }
...
inline flatbuffers::Offset<BufferView> CreateBufferView(flatbuffers::FlatBufferBuilder &_fbb,
                                                        int32_t buffer = 0, int32_t byteLength = 0,
...
struct Buffer FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
    enum { VT_BYTELENGTH = 4, VT_URI = 6 };
    int32_t byteLength() const { return GetField<int32_t>(VT_BYTELENGTH, 0); }
    const flatbuffers::String *uri() const {
        return GetPointer<const flatbuffers::String *>(VT_URI);
    }
    bool Verify(flatbuffers::Verifier &verifier) const {
        return VerifyTableStart(verifier) && VerifyField<int32_t>(verifier, VT_BYTELENGTH) &&
               VerifyOffset(verifier, VT_URI) && verifier.VerifyString(uri()) &&
               verifier.EndTable();
    }
};
...
inline flatbuffers::Offset<Buffer> CreateBufferDirect(flatbuffers::FlatBufferBuilder &_fbb,
                                                      int32_t byteLength = 0,
                                                      const char *uri = nullptr) {
    return gltf::CreateBuffer(_fbb, byteLength, uri ? _fbb.CreateString(uri) : 0);
}
...
struct GLTF FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
    ...
    const Asset *asset() const { return GetPointer<const Asset *>(VT_ASSET); }
    int32_t scene() const { return GetField<int32_t>(VT_SCENE, 0); }
    ...
    const flatbuffers::Vector<flatbuffers::Offset<Animation>> *animations() const {
        return GetPointer<const flatbuffers::Vector<flatbuffers::Offset<Animation>> *>(
            VT_ANIMATIONS);
    }
    ...
    const flatbuffers::Vector<flatbuffers::Offset<BufferView>> *bufferViews() const {
        return GetPointer<const flatbuffers::Vector<flatbuffers::Offset<BufferView>> *>(
            VT_BUFFERVIEWS);
    }
    ...
    bool Verify(flatbuffers::Verifier &verifier) const {
        return VerifyTableStart(verifier) && VerifyOffset(verifier, VT_ASSET) &&
               verifier.VerifyTable(asset()) && VerifyField<int32_t>(verifier, VT_SCENE) &&
               VerifyOffset(verifier, VT_SCENES) && verifier.VerifyVector(scenes()) &&
               verifier.VerifyVectorOfTables(scenes()) && VerifyOffset(verifier, VT_NODES) &&
               verifier.VerifyVector(nodes()) && verifier.VerifyVectorOfTables(nodes()) &&
               VerifyOffset(verifier, VT_ANIMATIONS) && verifier.VerifyVector(animations()) &&
               verifier.VerifyVectorOfTables(animations()) &&
               VerifyOffset(verifier, VT_MATERIALS) && verifier.VerifyVector(materials()) &&
               ...
               verifier.VerifyVectorOfTables(textures()) && VerifyOffset(verifier, VT_IMAGES) &&
               verifier.VerifyVector(images()) && verifier.VerifyVectorOfTables(images()) &&
               VerifyOffset(verifier, VT_ACCESSORS) && verifier.VerifyVector(accessors()) &&
               verifier.VerifyVectorOfTables(accessors()) &&
               VerifyOffset(verifier, VT_BUFFERVIEWS) && verifier.VerifyVector(bufferViews()) &&
               verifier.VerifyVectorOfTables(bufferViews()) && VerifyOffset(verifier, VT_BUFFERS) &&
...
struct GLTFBuilder {
    flatbuffers::FlatBufferBuilder &fbb_;
    flatbuffers::uoffset_t start_;
    void add_asset(flatbuffers::Offset<Asset> asset) { fbb_.AddOffset(GLTF::VT_ASSET, asset); }
    void add_scene(int32_t scene) { fbb_.AddElement<int32_t>(GLTF::VT_SCENE, scene, 0); }
    ...
    void add_animations(
        flatbuffers::Offset<flatbuffers::Vector<flatbuffers::Offset<Animation>>> animations) {
        fbb_.AddOffset(GLTF::VT_ANIMATIONS, animations);
    }
    void add_materials(
        flatbuffers::Offset<flatbuffers::Vector<flatbuffers::Offset<Material>>> materials) {
    ...
    void add_textures(
        flatbuffers::Offset<flatbuffers::Vector<flatbuffers::Offset<Texture>>> textures) {
    ...
    void add_accessors(
        flatbuffers::Offset<flatbuffers::Vector<flatbuffers::Offset<Accessor>>> accessors) {
        fbb_.AddOffset(GLTF::VT_ACCESSORS, accessors);
    }
    void add_bufferViews(
        flatbuffers::Offset<flatbuffers::Vector<flatbuffers::Offset<BufferView>>> bufferViews) {
        fbb_.AddOffset(GLTF::VT_BUFFERVIEWS, bufferViews);
    }
    void add_buffers(
        flatbuffers::Offset<flatbuffers::Vector<flatbuffers::Offset<Buffer>>> buffers) {
        fbb_.AddOffset(GLTF::VT_BUFFERS, buffers);
    }
    explicit GLTFBuilder(flatbuffers::FlatBufferBuilder &_fbb) : fbb_(_fbb) {
        start_ = fbb_.StartTable();
    }
...
inline flatbuffers::Offset<GLTF> CreateGLTF(
    flatbuffers::FlatBufferBuilder &_fbb, flatbuffers::Offset<Asset> asset = 0, int32_t scene = 0,
...
inline flatbuffers::Offset<GLTF> CreateGLTFDirect(
    ...
    return gltf::CreateGLTF(
        _fbb, asset, scene, scenes ? _fbb.CreateVector<flatbuffers::Offset<Scene>>(*scenes) : 0,
...
inline const gltf::GLTF *GetGLTF(const void *buf) { return flatbuffers::GetRoot<gltf::GLTF>(buf); }
...
inline bool VerifySizePrefixedGLTFBuffer(flatbuffers::Verifier &verifier) {
    return verifier.VerifySizePrefixedBuffer<gltf::GLTF>(nullptr);
}

inline void FinishGLTFBuffer(flatbuffers::FlatBufferBuilder &fbb,
                             flatbuffers::Offset<gltf::GLTF> root) {
    fbb.Finish(root);
}

inline void FinishSizePrefixedGLTFBuffer(flatbuffers::FlatBufferBuilder &fbb,
                                         flatbuffers::Offset<gltf::GLTF> root) {

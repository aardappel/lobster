...
// Every op the generated code can call, with how many int arguments each takes, grouped
// by the shape of its signature. The VM implements these as the U_ functions in vmops.h,
// the C backend declares them from these lists, and vm.cpp wraps them for the JIT.
...
#define VM_OPS_ALL VM_OPS_BASE VM_OPS_LVAL VM_OPS_LV VM_OPS_CALL VM_OPS_VARARG \
                   VM_OPS_JUMP1 VM_OPS_JUMP2

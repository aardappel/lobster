...
extern bool SDLHaltSound(int ch);
extern bool SDLPauseSound(int ch);
extern bool SDLIsPausedSound(int ch);
extern bool SDLResumeSound(int ch);
extern bool SDLSetVolume(int ch, float vol);

...
void AddSound() {
    ...
    ENDDECL1(play_wav, "filename", "S", "I",
        "plays a sound defined by a wav file (RAW or MS-ADPCM, any bitrate other than 44.1khz 16bit"
        " will automatically be converted on first load). returns false on error");
    ...
    ENDDECL1(play_sfxr, "filename", "S", "I",
        ...
        " to generate these). returns false on error");
}
